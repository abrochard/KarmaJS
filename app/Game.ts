...
//                 p.animations.push(cardDrawAnimation(p, CardType.Hand, faceDown))

//                 let faceUp = this.deck.draw();
//                 faceUp.flip();
//                 p.animations.push(cardDrawAnimation(p, CardType.FaceUp, faceUp));

//                 let h = this.deck.draw();
//                 p.animations.push(cardDrawAnimation(p, CardType.FaceDown, h));
//             });
